    ...
    return(
        ...
        <section className="lg:pt-20 "  id="home-section">
           <div className="flex flex-col  items-center justify-center  gap-4 ">
                ...
                <div className=" flex justify-center sm:mx-3 mobile:mx-7">
                <Image src={Dashboard} alt="image" className="align-middle rounded-2xl    shadow-slate-500 shadow-xl" aria-label="Dashboard Image"  />
                </div>
           </div>
        </section>
