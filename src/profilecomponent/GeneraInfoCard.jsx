const LitlleCard = ({title, value}) => {
    return (
        <div className=" rounded-xl p-3 pl-5 shadow-md shadow-gray-200">
...
export default function GeneralInfoCard() {
    return (
        <div className="flex flex-col gap-3 text-slate-400 bg-white rounded-2xl  p-5 shadow-lg shadow-gray-200">
